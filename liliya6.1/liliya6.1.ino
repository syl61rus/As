...
int ledProg(){
  ...
  static int timeLed;
  static int shimLed = 255;
  static int shimLedTime = 100;
  ...
  if (cMillis - pMillis >intervalled){
    ...
    timeLed++;
          ...
          if(timeLed == 5 && timeLed != 9){
             if (cMillis - pMillis >shimLedTime){
    pMillis = cMillis;
    shimLed--;
             }
    analogWrite(10,shimLed);
          }
           if(timeLed == 9){
             timeLed = 0;
             progLed = true;
  ...
  int shim(){
    ...
    shimLed++;
    blueShim ++;
    Serial.println(shimLed);
    Serial.println(blueShim);
      if (shimLed >= 255 && shimLed != 510){
          redShim++;
          blueShim--;
      }
    }
   ...
   analogWrite(11,blueShim);
   analogWrite(10,redShim);
